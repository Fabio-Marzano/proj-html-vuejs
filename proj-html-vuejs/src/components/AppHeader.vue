<template lang="">
  <div>
    ...
    <main>
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-8">
            <div class="col">
    <div class="card h-100 ml-20">
      <img src="../assets/Img/cat_1-1540x750.jpg" class="card-img-top" alt="...">
      <div class="card-body">
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-4">
            <div class="col">
    <div class="card h-100 ml-20 mt-3">
      <img src="../assets/Img/cat_5-370x155.jpg" class="card-img-top" alt="...">
      <div class="card-body card-img-2">
    ...
    <div class="card h-100 mt-3">
      <img src="../assets/Img/cat_4-370x155.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        ...
        <p class="card-text">Exercise</p>
          ...
          <div class="col-4">
            <div class="col">
    <div class="card h-100 mt-3">
      <img src="../assets/Img/cat_6-370x155.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="card-body card-img">
    ...
    <p class="card-text f-size-2">Basics of Masterstudy</p>
      ...
      <div class="container-fluid bg-container container-h">
        <div class="row">
          <div class="col-12">
            ...
            <p class="text-center mt-4 text-dark">Discover or most popular courses for self learning</p>
          </div>
        </div>
        <div class="row mt-4">
          <div class="col-2">
